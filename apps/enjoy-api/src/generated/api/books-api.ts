...
export const BooksApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.addBook(
        createBookDto,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['BooksApi.addBook']?.[localVarOperationServerIndex]
          ?.url;
    ...
    async getAllBooks(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<BookDto>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getAllBooks(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['BooksApi.getAllBooks']?.[
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getAllBooksByAuthor(author, options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['BooksApi.getAllBooksByAuthor']?.[
          localVarOperationServerIndex
        ]?.url;
      return (axios, basePath) =>
        createRequestFunction(
...
export const BooksApiFactory = function (
  ...
  return {
    ...
    getAllBooksByAuthor(
      author: string,
      options?: any,
    ): AxiosPromise<Array<BookDto>> {
      return localVarFp
        .getAllBooksByAuthor(author, options)
        .then((request) => request(axios, basePath));
    },
  };
};
