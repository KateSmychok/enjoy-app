...
export const GamesApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async addGame(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<GameDto>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.addGame(
        createGameDto,
        options,
      );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['GamesApi.addGame']?.[localVarOperationServerIndex]
          ?.url;
    ...
    async getAllGames(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<Array<GameDto>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getAllGames(options);
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap['GamesApi.getAllGames']?.[
...
export const GamesApiFactory = function (
  ...
  return {
    ...
    addGame(
      createGameDto: CreateGameDto,
      options?: any,
    ): AxiosPromise<GameDto> {
      return localVarFp
        .addGame(createGameDto, options)
